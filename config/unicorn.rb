...
# use 60 sec timeout per suggestion from 
# http://stackoverflow.com/questions/14044659/nginx-rails-and-oauth-upstream-prematurely-closed-connection 
timeout 60 
...
before_fork do |server, worker| 
  ...
  old_pid = "/tmp/unicorn.viz.pid.oldbin" 
